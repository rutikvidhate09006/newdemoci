    ...
    <div class="w-full md:w-1/2">
     <h1 class="text-2xl md:text-3xl font-bold text-[#ca2212]">
      ...
      <p class="mt-2 text-justify text-[#555]">
        ...
        Whether you are looking for a <strong>Gearbox in <?= esc($title) ?></strong> or other intricate components, 
      ...
      <h2 class="text-2xl md:text-3xl mt-6 text-[#272727]">
        Get Premium Products Directly from Gearbox Manufacturers in <?= esc($title) ?>
      </h2>
      <p class="mt-2 text-justify text-[#555]">
          ...
          <div class="overflow-hidden relative">
               <div class="flex w-max gap-12 logo-slider-track">
                  ...
                  <!-- Add your client logos here -->
                      <img src="https://via.placeholder.com/120x60?text=Logo+1" class="h-16 object-contain" alt="Logo 1">
                      <img src="https://via.placeholder.com/120x60?text=Logo+2" class="h-16 object-contain" alt="Logo 2">
                      <img src="https://via.placeholder.com/120x60?text=Logo+3" class="h-16 object-contain" alt="Logo 3">
                      <img src="https://via.placeholder.com/120x60?text=Logo+4" class="h-16 object-contain" alt="Logo 4">
                      <img src="https://via.placeholder.com/120x60?text=Logo+5" class="h-16 object-contain" alt="Logo 5">
                      <img src="https://via.placeholder.com/120x60?text=Logo+6" class="h-16 object-contain" alt="Logo 6">
                      <img src="https://via.placeholder.com/120x60?text=Logo+7" class="h-16 object-contain" alt="Logo 7">
